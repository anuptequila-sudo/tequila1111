...
export default function PortfolioSection() {
  ...
  useEffect(() => {
    ...
    const cards = Array.from(
      wrapper.querySelectorAll(".portfolioCard")
    ) as HTMLElement[];
      ...
      <div className="container-fixed">
        <div className={styles.headerWrapper}>
          ...
          <div className={styles.headerText} data-come-up-anime>
            ...
            We've teamed up with founders, innovators, and ambitious brands to
            create work that leads. From first spark to final screen — this is
            where strategy meets creative craft, with impact built in.
          </div>
        </div>
        ...
        <div className={`${styles.portfolioDetail} portfolioDetail`}>
          {portfolioItems.map((item, i) => (
            <div
              key={i}
              className={`${styles.portfolioCard} portfolioCard`}
